...
| A 键 | 普通界面长按打开眼睛菜单，短按无操作；与 B 同时双击触发生日彩蛋；菜单内单击浏览/调档、双击确认；诊断模式震动测试 | 已接入；生日彩蛋的实体双键节奏仍需真机人工验收 |
| B 键 | 普通界面长按打开独立模式菜单、短按无操作；阅读中短按补完/翻页、长按退出；与 A 同时双击触发生日彩蛋；眼睛菜单内返回；诊断模式重绘 | 模式菜单进入、等待和返回已在真机日志运行；丝滑程度与生日彩蛋双键节奏仍需用户目视验收 |
