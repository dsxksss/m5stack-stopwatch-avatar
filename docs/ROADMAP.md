...
- a full-screen hold-B reading menu with an offline SPIFFS bookshelf, persistent chapter/block/page progress and volatile LAN text delivery;
...
- add fixture-based parser tests for local chapter catalogues and text blocks;
